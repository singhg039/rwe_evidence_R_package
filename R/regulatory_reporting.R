...
#' @keywords internal
export_table_one_latex <- function(table_one, output_file, title) {
  # Simplified LaTeX export - full implementation would be more complex
  cat("LaTeX export not yet fully implemented\n")
  cat("Use CSV or HTML format instead\n")
}
